...
/**
 * Reads on-wiki preferences overrides from MediaWiki:Wiki7-preferences.json
 * and resolves custom i18n message keys for the client-side module.
 */
class PreferencesConfigProvider {

	private const PAGE_NAME = 'Wiki7-preferences.json';
	...
	/**
	 * Read and parse MediaWiki:Wiki7-preferences.json.
	 *
