<template>
	...
	>
		<section
			...
			class="wiki7-preferences-section"
		>
			<div class="wiki7-preferences-section__heading">
				{{ section.label }}
			</div>
			<div class="wiki7-preferences-section__content">
				<template
...
const { CdxField, CdxSelect, CdxToggleSwitch } = mw.loader.require( 'skins.wiki7.preferences.codex' );
...
module.exports = exports = defineComponent( {
	...
	setup() {
		...
		// Fires mw.hook( 'wiki7.preferences.changed' ) with ( featureName, value )
		function setValue( featureName, value ) {
			...
			mw.hook( 'wiki7.preferences.changed' ).fire( featureName, value );
