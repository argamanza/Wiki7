 ...
 */
const
	DROPDOWN_CONTAINER_SELECTOR = '.wiki7-dropdown',
	DROPDOWN_DETAILS_SELECTOR = '.wiki7-dropdown-details',
	DROPDOWN_SUMMARY_SELECTOR = '.wiki7-dropdown-summary',
	DROPDOWN_TARGET_SELECTOR = '.wiki7-menu__card';
