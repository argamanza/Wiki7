...
function findMatchingCommand( query ) {
	...
	if ( !handler ) {
		mw.log.warn( `[skins.wiki7.commandPalette|CommandProvider] Handler for command "${ id }" (matched via trigger "${ trigger }") not found in registry. This indicates an inconsistency.` );
		return null;
	}
