...
const RelatedArticlesProvider = {
	...
	label: mw.message( 'wiki7-command-palette-heading-related' ).text(),
		...
		fetchPromise = new Promise( ( resolve ) => {
			const onSuccess = async ( require ) => {
				try {
					...
					mw.log.error( '[skins.wiki7.commandPalette] RelatedArticlesProvider: Error inside mw.loader success callback:', error );
