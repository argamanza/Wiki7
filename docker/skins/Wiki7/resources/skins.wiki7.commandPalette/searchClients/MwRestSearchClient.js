...
const { Wiki7CommandPaletteSearchClient, CommandPaletteSearchResponse, AbortableSearchFetch } = require( '../types.js' );
...
/**
 * @class
 * @implements {Wiki7CommandPaletteSearchClient}
 */
	...
	adaptApiResponse( query, response, showDescription ) {
		return {
			...
			results: response.pages.map( ( page ) => {
				...
				return {
					id: `wiki7-command-palette-item-page-${ page.key }`,
					type: 'page',
					label: page.title,
