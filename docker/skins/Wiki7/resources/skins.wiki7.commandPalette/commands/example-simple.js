 ...
 * for places like MediaWiki:Wiki7.js or gadgets.
 *
...
mw.loader.using( 'skins.wiki7.commandPalette' ).then( () => {
	mw.hook( 'skins.wiki7.commandPalette.registerCommand' ).add( ( registrationData ) => {
