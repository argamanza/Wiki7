...
function fetchMenuItems() {
	...
	TARGET_PORTLET_IDS.forEach( ( portletId ) => {
		...
		const menuLabel = portletElement.querySelector( '.wiki7-menu__heading' )?.textContent?.trim();
		const links = portletElement.querySelectorAll( '.wiki7-menu__content-list li a' );
