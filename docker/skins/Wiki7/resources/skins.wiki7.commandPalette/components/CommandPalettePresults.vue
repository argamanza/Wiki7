<template>
	...
	<command-palette-list
		...
		:heading="$i18n( 'wiki7-command-palette-heading-related' ).text()"
	...
	<command-palette-list
		...
		:heading="$i18n( 'wiki7-command-palette-heading-recent' ).text()"
	...
	<command-palette-empty-state
		...
		:description="$i18n( 'wiki7-search-empty-desc' ).text()"
